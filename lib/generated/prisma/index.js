...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Wad\\Desktop\\apps\\nebula-next\\lib\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Wad\\Desktop\\apps\\nebula-next\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://neondb_owner:npg_noA8Itk3rchO@ep-holy-feather-a28ih6mh-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../lib/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  email     String   @unique\n  name      String?\n  password  String\n  createdAt DateTime @default(now())\n  updateAt  DateTime @updatedAt\n  tickets   Ticket[]\n}\n\nmodel Ticket {\n  id          String   @id @default(uuid())\n  subject     String\n  description String\n  priority    String\n  status      String   @default(\"Open\")\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n  user        User     @relation(fields: [userId], references: [id])\n  userId      String\n}\n",
  "inlineSchemaHash": "ca634d13d788f20dabac254ed6a980eab2f943a71945853509f0a670e231f13e",
  "copyEngine": true
}
